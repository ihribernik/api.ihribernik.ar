...
from app.presentation.schemas.category import CategoryResponse, CategoryRequest
...
async def get(category_id: int, use_case: GetCategoryById = Depends()) -> CategoryResponse:
...
async def update(category_id: int, use_case: UpdateCategory = Depends()) -> CategoryResponse:
    category = use_case.execute(category_id)
